...
class ExamModel extends Model
{
    ...
    protected $allowedFields    = ['examId', 'examName', 'examCode', 'description', 'subject', 'academicYear','businessId', 'createdBy', 'createdDate', 'modifiedBy', 'modifiedDate', 'isActive', 'isDeleted'];
