...
class ItemCategory extends Model
{
    ...
    protected $allowedFields    = ['itemCategoryId', 'itemCategoryName','coverImage', 'description','isActive','businessId','isDeleted', 'modifiedDate', 'modifiedBy', 'createdDate', 'createdBy'];
