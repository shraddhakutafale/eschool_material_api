...
class ItemModel extends Model
{
    ...
    protected $allowedFields    = ['itemId','itemType', 'itemName','itemCode','coverImage', 'productImages', 'itemTypeId', 'categoryInputFieldValues', 'itemCategoryId','itemSubCategoryId', 'brandName', 'unit', 'unitSize', 'mrp', 'sku','startDate','duration', 'gstPercentage', 'discountType', 'discount', 'barcode', 'hsnCode', 'minStockLevel', 'description', 'tags','feature', 'termsCondition', 'type', 'netQuantity', 'selectUnit', 'assignBy','unitName','finalPrice','businessId','createdBy', 'createdDate', 'modifiedBy', 'modifiedDate', 'isActive', 'isDeleted'];
