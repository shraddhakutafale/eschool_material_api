...
class LeadModel extends Model
{
    ...
    protected $allowedFields    = ['leadId', 'fName', 'lName','companyName','requirementDetails','inquiryNo','projectType','location','address', 'primaryMobileNo', 'secondaryMobileNo', 'whatsAppNo', 'email', 'leadInterestedId', 'leadInterestedIdValue', 'leadSourceId', 'leadSourceName', 'leadSourceValue', 'status', 'followUpDate', 'remark','businessId', 'isActive', 'isDeleted', 'createdBy', 'createdDate', 'modifiedBy', 'modifiedDate'];
