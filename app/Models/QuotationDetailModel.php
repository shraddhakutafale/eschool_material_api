...
class QuotationDetailModel extends Model
{
    ...
    protected $allowedFields    = [  'quoteItemId', 'quoteId','itemId', 'item', 'itemCode','unitName','unitSize','quantity', 'rate', 'amount', 'isActive', 'isDeleted', 'modifiedBy', 'modifiedDate', 'createdDate', 'createdBy'];
