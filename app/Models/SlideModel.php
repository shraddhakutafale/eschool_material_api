...
class SlideModel extends Model
{
    ...
    protected $allowedFields    = ['slideId', 'title', 'profilePic', 'content','showButton', 'buttonUrl', 'buttonText', 'businessId','isActive', 'isDeleted', 'createdBy', 'createdDate', 'modifiedBy', 'modifiedDate'];
