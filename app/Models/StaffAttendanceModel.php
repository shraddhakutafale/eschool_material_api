...
class StaffAttendanceModel extends Model
{
    ...
    protected $allowedFields    = [ 'attendanceId','staffId', 'businessId', 'attendanceDate', 'inTime', 'outTime', 'deviceId', 'status', 'present','createdDate', 'modifiedDate', 'createdBy', 'modifiedBy'];
