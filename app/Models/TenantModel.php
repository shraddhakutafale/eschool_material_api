...
class TenantModel extends Model
{
    ...
    protected $allowedFields    = ['tenantId', 'tenantName', 'databaseName', 'username', 'password', 'hostUrl', 'businessId', 'createdBy', 'createdDate', 'modifiedBy', 'modifiedDate', 'isActive', 'isDeleted'];
