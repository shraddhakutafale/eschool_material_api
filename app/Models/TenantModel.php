...
class TenantModel extends Model
{
    ...
    protected $allowedFields    = ['tenantId', 'tenantName', 'databaseName', 'username', 'password', 'hostUrl', 'categoryId', 'createdBy', 'createdDate', 'modifiedBy', 'modifiedDate', 'isActive', 'isDeleted'];
