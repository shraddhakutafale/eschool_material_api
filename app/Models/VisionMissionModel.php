...
class VisionMissionModel extends Model
{
    ...
    protected $primaryKey       = 'visionMissionId';
    protected $useAutoIncrement = true;
    protected $returnType       = 'array';
    protected $useSoftDeletes   = false;
    protected $protectFields    = true;
    protected $allowedFields    = ['visionMissionId', 'type', 'title', 'description', 'businessId', 'createdBy', 'modifiedBy', 'createdDate', 'modifiedDate', 'isActive', 'isDeleted'];
